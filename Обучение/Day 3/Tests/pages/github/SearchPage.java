...
public class SearchPage {
    ...
    public ru.technoserv.atmaven.tests.pages.github.UserProfilePage openUserProfile(String username) {
        usersResults().find(By.linkText(username)).click();
        return page(ru.technoserv.atmaven.tests.pages.github.UserProfilePage.class);
    }
}